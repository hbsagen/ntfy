...
- Tableau — Possible: yes. Method: webhook/script. Quirks: use subscriptions or webhooks in Tableau Cloud. Docs: https://help.tableau.com/
...
- Metabase — Possible: yes. Method: webhook. Quirks: alerts + webhook on Pro/Enterprise. Docs: https://www.metabase.com/
- Apache Superset — Possible: yes. Method: webhook/script. Quirks: alerts via email; use email bridge or report schedules. Docs: https://superset.apache.org/
- Redash — Possible: yes. Method: webhook. Quirks: alert destinations. Docs: https://redash.io/
