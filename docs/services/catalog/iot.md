...
- UPS (NUT) — Possible: yes. Method: script. Quirks: upssched hooks. Docs: https://networkupstools.org/docs/
...
- Homey — Possible: yes. Method: webhook. Quirks: flow with HTTP request. Docs: https://apps.developer.homey.app/the-basics/webhooks
