...
- Mattermost — Possible: yes. Method: webhook. Quirks: outgoing webhooks. Docs: https://docs.mattermost.com/developer/webhooks.html
- Rocket.Chat — Possible: yes. Method: webhook. Quirks: outgoing integrations. Docs: https://developer.rocket.chat/reference/api/rest-api/endpoints/webhooks
...
- Rocket.Chat Apps — Possible: yes. Method: webhook. Quirks: use outgoing webhook apps. Docs: https://developer.rocket.chat/apps-engine
