...
- SourceHut — Possible: yes. Method: webhook. Quirks: webhook per repo. Docs: https://man.sr.ht/git.sr.ht/webhooks.md
...
- Launchpad — Possible: yes. Method: polling/script. Quirks: limited webhooks; use API polling. Docs: https://launchpad.net/+apidoc
