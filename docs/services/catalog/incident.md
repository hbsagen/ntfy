...
- Statuspage (incident creation) — Possible: yes. Method: script/webhook. Quirks: use API for incidents. Docs: https://developer.atlassian.com/cloud/statuspage/rest/api-group-incidents/
...
- Better Stack Status Page — Possible: yes. Method: webhook. Quirks: integrations. Docs: https://betterstack.com/docs/status-pages/
...
- Jira Service Management — Possible: yes. Method: webhook. Quirks: automation rules. Docs: https://support.atlassian.com/jira-service-management-cloud/docs/webhooks/
- Atlassian Statuspage (webhooks) — Possible: yes. Method: webhook. Quirks: outgoing webhooks per incident. Docs: https://support.atlassian.com/statuspage/docs/webhooks/
- Statuscast — Possible: yes. Method: webhook. Quirks: use incident webhooks. Docs: https://www.statuscast.com/docs/
- Better Stack On-Call — Possible: yes. Method: webhook. Quirks: use outbound webhooks. Docs: https://betterstack.com/docs/on-call/
