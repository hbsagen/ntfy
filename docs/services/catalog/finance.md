...
- Wave — Possible: yes. Method: webhook/script. Quirks: limited webhook support; use API polling. Docs: https://developer.waveapps.com/hc/en-us
...
- Chargebee — Possible: yes. Method: webhook. Quirks: event verification. Docs: https://www.chargebee.com/docs/2.0/webhooks.html
